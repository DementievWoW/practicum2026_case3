...
> **Это «старый» ресёрч (круги 1–5).** Материалы круга 6 (ансамбли/голосование/boosting + знаниевый RAG для детекции, под [ADR-0012](../../docs/adr/0012-ensemble-gen-judge-asymmetric-retrieval.md)) вынесены отдельно — см. [`research/materials_round6/`](../materials_round6/).
